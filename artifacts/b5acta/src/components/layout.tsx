        ...
        <nav className="p-4 flex flex-col gap-2 hide-scrollbar overflow-y-auto overflow-x-hidden">
          ...
          {navMenuOpen && (
            <div className="flex flex-col gap-1 border-l border-border/70 pl-2">
              ...
              {showLocalToolingNav && (
                <Link onClick={() => mobileChrome && setNavOpen(false)} href="/los-test" className="flex items-center gap-3 px-3 py-2 rounded-md hover:bg-secondary/50 text-muted-foreground hover:text-foreground transition-colors shrink-0">
                  <Crosshair className="w-4 h-4" />
                  <span className="text-sm font-medium tracking-wide uppercase">LOS Test</span>
                </Link>
              )}
