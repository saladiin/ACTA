...
const MODEL_SCALE_MULTIPLIERS: Record<string, number> = {
  ...
  "omega.glb": 1.6,
  "nova.glb": 1.45,
  [RAIDER_NOVA_MODEL_FILENAME]: 1.45,
  "orestes.glb": 1.65,
  "tethys.glb": 0.4,
...
const MODEL_ABSOLUTE_SCALES: Record<string, number> = {
  ...
  [OMEGA_ROTATING_MODEL_FILENAME]: 0.0036727814,
  [COMMAND_OMEGA_MODEL_FILENAME]: 0.0036727814,
  [OMEGA_X_MODEL_FILENAME]: 0.0035495822,
  [PSI_CORPS_FIGHTER_CARRIER_MODEL_FILENAME]: 0.00565,
  [PSI_CORPS_MOTHERSHIP_MODEL_FILENAME]: 0.00300057,
  [CORPORATE_FREIGHTER_MODEL_FILENAME]: 0.00475,
