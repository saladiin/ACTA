...
const SHIP_PRIORITY_SEEDS: Array<{ name: string; priority: string }> = [
  ...
  { name: "Psi-Corps Fighter Carrier", priority: "skirmish" },
  { name: "Shadowcloak Escort", priority: "patrol" },
  { name: "Shadowcloak-class Escort", priority: "patrol" },
...
const CSV_MODEL_FILENAMES: Record<string, string> = {
  ...
  "psi-corps fighter carrier": "psicorp-fighter-carrier.glb",
  "psicorp fighter carrier": "psicorp-fighter-carrier.glb",
...
const RAIDER_MODIFIED_FREIGHTER_WEAPONS = [
  {
    name: "Plasma Cannon",
    arc: "Forward",
    range: 8,
...
const PSI_CORPS_FIGHTER_CARRIER_WEAPONS = [
  {
    name: "Medium Pulse Cannon",
    arc: "Forward",
    range: 10,
...
const SHADOWCLOAK_ESCORT_WEAPONS = [
  {
    name: "Medium Pulse Cannon",
    arc: "Forward",
    range: 10,
...
const TIKRIT_WEAPONS = [
  ...
  },
  {
    ...
    range: 24,
    attackDice: 4,
    traits: "Armor Piercing; Double Damage; Slow Loading",
  },
  {
    name: "Anti-Ship Missiles",
    arc: "Forward",
...
const SHIP_MAINTENANCE_SEEDS: ShipMaintenanceSeed[] = [
  ...
  },
  {
    ...
    aliases: [
      "Modified Freighter",
      "Raider Modified Freighter",
      "Raiders Modified Freighter",
      "Modified Freighter Patrol",
    ],
    filename: "raider-freighter.glb",
    faction: "Raiders",
    pointCost: 25,
    priorityLevel: "patrol",
    shipClass: "Modified Freighter",
    hull: 5,
    troops: 1,
    damage: 12,
    damageThreshold: 3,
    ...
    smallCraft: "Delta-V Fighter Flight (1)",
    weaponRange: 8,
    weaponDamage: 6,
    description:
  ...
  {
    name: "Fighter Carrier",
    aliases: [
      "Fighter Carrier",
      "Psi Corps Fighter Carrier",
      "Psi-Corps Fighter Carrier",
      "PsiCorp Fighter Carrier",
      "Psi Corps Modified Fighter Carrier",
    ],
    filename: "psicorp-fighter-carrier.glb",
    faction: "Psi Corps",
    pointCost: 150,
    priorityLevel: "skirmish",
    shipClass: "Fighter Carrier",
    hull: 4,
    troops: 1,
    damage: 22,
    damageThreshold: 5,
    ...
    crewQuality: "Regular",
    traits:
      "Advanced Jump Engine; Anti-Fighter 4; Lumbering; Psychic Crew 4; Stealth +3",
    smallCraft: "Black Omega Starfury Flight (2)",
    weaponRange: 10,
    weaponDamage: 6,
    description:
      "Psi Corps Skirmish-level Fighter Carrier with stealth systems and two Black Omega Starfury flights",
    weapons: PSI_CORPS_FIGHTER_CARRIER_WEAPONS,
  },
  {
    name: "Shadowcloak Escort",
    aliases: [
      "Shadowcloak Escort",
      "Shadowcloak-class Escort",
      "Shadowcloak",
      "Psi Corps Shadowcloak Escort",
    ],
    filename: "shadowcloak.glb",
    faction: "Psi Corps",
    pointCost: 25,
    priorityLevel: "patrol",
    shipClass: "Escort",
    ...
    baseRadiusInches: 0.75,
    crewQuality: "Regular",
    traits: "Interceptors 1; Psychic Crew 4; Scout; Stealth +4",
    smallCraft: null,
    weaponRange: 10,
    weaponDamage: 4,
    description:
      "Psi Corps Patrol-level Shadowcloak-class escort, a stealthy telepathic listening post with scout systems",
    weapons: SHADOWCLOAK_ESCORT_WEAPONS,
  },
  {
  ...
  {
    name: "Tikrit-class Heavy Cruiser",
    aliases: [
      "Tikrit-class Heavy Cruiser",
      "Tikrit Heavy Cruiser",
      "Tikrit",
    ],
    filename: "dilgar-tikrit.glb",
    ...
    smallCraft: "Thorun Dartfighter Flight (2)",
    weaponRange: 24,
    weaponDamage: 18,
    description:
      "Dilgar Imperium Tikrit-class heavy cruiser, in service 2231-2232",
    weapons: TIKRIT_WEAPONS,
  },
  {
    name: "Garasoch-class Heavy Carrier",
    aliases: [
      "Garasoch-class Heavy Carrier",
      "Garasoch Heavy Carrier",
      "Garasoch",
    ],
    filename: "dilgar-garasoch.glb",
    faction: "Dilgar Imperium",
    pointCost: 200,
    priorityLevel: "raid",
    shipClass: "Heavy Carrier",
    ...
    crewQuality: "Regular",
    traits:
      "Anti-Fighter 2; Carrier 3; Fleet Carrier; Jump Engine; Lumbering",
    smallCraft: "Thorun Dartfighter Flight (10)",
    weaponRange: 15,
    weaponDamage: 6,
    description:
      "Dilgar Imperium Garasoch-class heavy carrier, in service 2230-2232",
    weapons: GARASOCH_WEAPONS,
  },
  {
    name: "Omelos-class Light Cruiser",
    aliases: [
      "Omelos-class Light Cruiser",
      "Omelos Light Cruiser",
      "Omelos",
    ],
    filename: "dilgar-omelos.glb",
    faction: "Dilgar Imperium",
    pointCost: 200,
    priorityLevel: "raid",
    ...
    turnAngle: 45,
    crewQuality: "Regular",
    traits: "Agile; Anti-Fighter 2",
    smallCraft: "Thorun Dartfighter Flight (1)",
    weaponRange: 24,
    weaponDamage: 6,
    description:
      "Dilgar Imperium Omelos-class light cruiser, in service 2202-2232",
    weapons: OMELOS_WEAPONS,
  },
  {
