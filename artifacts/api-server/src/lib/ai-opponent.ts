...
export const SHIP_AI_PROFILE_SEEDS: Array<{ name: string; aiProfile: ShipAiProfile }> = [
  ...
  { name: "Hyperion Heavy Cruiser (Third Age)", aiProfile: "jouster" },
  { name: "Hyperion Heavy Cruiser (Crusade Era)", aiProfile: "jouster" },
  { name: "Hyperion Assault Cruiser", aiProfile: "brawler" },
  { name: "Hyperion Assault Cruiser (Third Age)", aiProfile: "brawler" },
  { name: "Hyperion Assault Cruiser (Crusade Era)", aiProfile: "brawler" },
  ...
  { name: "Avenger Heavy Carrier (Third Age)", aiProfile: "standoff" },
  { name: "Avenger-class Heavy Carrier", aiProfile: "standoff" },
  { name: "Artemis-class Heavy Frigate (Third Age)", aiProfile: "standoff" },
  { name: "Explorer Survey Ship (Third Age)", aiProfile: "standoff" },
  { name: "Explorer Survey Ship (Crusade Era)", aiProfile: "standoff" },
  { name: "Hermes Transport", aiProfile: "standoff" },
  { name: "Hermes Transport (Third Age)", aiProfile: "standoff" },
  { name: "Hermes Transport (Crusade Era)", aiProfile: "standoff" },
  { name: "Olympus Corvette", aiProfile: "standoff" },
  { name: "Olympus Corvette (Third Age)", aiProfile: "standoff" },
  { name: "Oracle Cruiser", aiProfile: "standoff" },
  { name: "Oracle Scout Cruiser", aiProfile: "standoff" },
  { name: "Oracle Scout Cruiser (Third Age)", aiProfile: "standoff" },
  { name: "Omega Destroyer", aiProfile: "jouster" },
  { name: "Omega Destroyer (Crusade Era)", aiProfile: "jouster" },
  { name: "Omega Class Destroyer", aiProfile: "jouster" },
  { name: "Omega Command Destroyer", aiProfile: "jouster" },
  { name: "Omega Command Destroyer (Crusade Era)", aiProfile: "jouster" },
  { name: "Omega Pulse Destroyer", aiProfile: "broadside" },
  { name: "Shadow Omega Advanced Destroyer", aiProfile: "jouster" },
  { name: "Nova Dreadnought", aiProfile: "broadside" },
  { name: "Nova Dreadnought (Third Age)", aiProfile: "broadside" },
