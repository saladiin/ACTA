...
export const GetGameResponse = zod.object({
  ...
  "oneWeaponThisRound": zod.boolean().optional().describe('True when this ship may fire only one weapon system this round, as the cost of a successful \'all-hands-on-deck\' declaration in the previous End Phase. Latched at round rollover; cleared at the next rollover.'),
